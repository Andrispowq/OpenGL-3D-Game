...
#define PR_PROFILE(x) Timer(x)

//Colours: [0m resets the colour to white, [0;33m is yellow, [0;31m is red
#define PR_LOG_MESSAGE(...) Log::Log(WHITE, __VA_ARGS__)
#define PR_LOG_WARNING(...) Log::Log(YELLOW, __VA_ARGS__)
#define PR_LOG_ERROR(...) Log::Log(RED, __VA_ARGS__)
#define PR_LOG_RUNTIME_ERROR(...) Log::Log_RuntimeError(RED, __VA_ARGS__)
...
#define PR_LOG(x, ...) Log::Log(x, __VA_ARGS__)
