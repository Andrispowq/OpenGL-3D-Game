...
Vector4f Matrix4f::operator*(const Vector4f& v) const
{
	...
	__m128 res0 = _mm_mul_ps(_mm_set_ps(m[0 * 4 + 3], m[0 * 4 + 2], m[0 * 4 + 1], m[0 * 4 + 0]), _mm_set_ps(v.x, v.x, v.x, v.x));
	__m128 res1 = _mm_mul_ps(_mm_set_ps(m[1 * 4 + 3], m[1 * 4 + 2], m[1 * 4 + 1], m[1 * 4 + 0]), _mm_set_ps(v.y, v.y, v.y, v.y));
	__m128 res2 = _mm_mul_ps(_mm_set_ps(m[2 * 4 + 3], m[2 * 4 + 2], m[2 * 4 + 1], m[2 * 4 + 0]), _mm_set_ps(v.z, v.z, v.z, v.z));
	__m128 res3 = _mm_mul_ps(_mm_set_ps(m[3 * 4 + 3], m[3 * 4 + 2], m[3 * 4 + 1], m[3 * 4 + 0]), _mm_set_ps(v.w, v.w, v.w, v.w));
